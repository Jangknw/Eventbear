...
function DorpDownList() {
    ...
    GenDropDownList("Place_District", "http://localhost:56400/Home/DropDownDistrict", data);
    ...
    $("#Place_District").on("change", function () {
        ...
        GenDropDownList("Place_SubDistrict", "http://localhost:56400/Home/DropDownSubDistrict", data);
    });
}